...
<div class="subtitle">
Загрузка минутных данных MOEX для
исторического тестирования протокола v1.3.
</div>

<div class="badge">
M1 • MOEX ISS • Backtest
</div>
...
Для нескольких инструментов укажи SECID
через запятую.
...
Результатом будет ZIP-архив
с отдельным CSV для каждого инструмента.
